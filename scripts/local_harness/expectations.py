...
SKRIFT_ADMIN_PAGES: tuple[AdminPageCheck, ...] = (
    ...
    AdminPageCheck("admin-bot-bytes-config", f"/admin/bot/guilds/{_G}/bytes"),
    ...
    AdminPageCheck("admin-bot-campaigns", f"/admin/bot/guilds/{_G}/campaigns"),
    AdminPageCheck("admin-bot-campaign-create",
                   f"/admin/bot/guilds/{_G}/campaigns/create"),
    AdminPageCheck(
        "admin-bot-campaign-edit",
        f"/admin/bot/guilds/{_G}/campaigns/{config.CAMPAIGN_ID}/edit"),
    AdminPageCheck(
        "admin-bot-campaign-challenges",
        f"/admin/bot/guilds/{_G}/campaigns/{config.CAMPAIGN_ID}/challenges"),
    AdminPageCheck(
        "admin-bot-campaign-challenge-create",
        f"/admin/bot/guilds/{_G}/campaigns/{config.CAMPAIGN_ID}/challenges/create"),
    AdminPageCheck(
        "admin-bot-scheduled-messages",
        f"/admin/bot/guilds/{_G}/campaigns/{config.CAMPAIGN_ID}/scheduled-messages"),
    AdminPageCheck(
        "admin-bot-scheduled-message-create",
    ...
    AdminPageCheck("admin-bot-audit-logs", f"/admin/bot/guilds/{_G}/audit-logs"),
    AdminPageCheck("admin-bot-advent-of-code",
                   f"/admin/bot/guilds/{_G}/advent-of-code"),
    AdminPageCheck("admin-bot-attachment-filter",
                   f"/admin/bot/guilds/{_G}/attachment-filter"),
