...
from smarter_dev.web.crud import BytesOperations, BytesConfigOperations, SquadOperations, SquadSaleEventOperations, ForumAgentOperations, CampaignOperations, ScheduledMessageOperations, RepeatingMessageOperations, AuditLogConfigOperations, AdventOfCodeConfigOperations, AttachmentFilterConfigOperations, ConflictError
