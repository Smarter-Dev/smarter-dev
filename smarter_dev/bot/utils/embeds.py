...
def create_cooldown_embed(message: str, cooldown_end_timestamp: int | None = None) -> hikari.Embed:
...
def create_squad_list_embed(squads: list, current_squad_id: str | None = None) -> hikari.Embed:
