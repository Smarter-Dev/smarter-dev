...
replaced GPT-6 Luna here (Luna had replaced GPT-5.4 Nano on 2026-09-24);
``tests/integration/test_message_gate_quality_eval.py`` compares the two on
...
async def filter_messages(
    ...
    the bot. Cancellation is not a failure: it propagates.
    """
    if not candidates:
        return []
