...
class TestBytesServiceEdgeCases:
    ...
    async def test_zero_and_negative_edge_cases(self, edge_case_bytes_service):
        ...
        balance = await service.get_balance("123456789012345678", "111111111111111111")
        ...
        poor_user = MockUser("111111111111111111", "PoorUser")
        rich_user = MockUser("222222222222222222", "RichUser")
    ...
    async def test_unicode_and_special_characters(self, edge_case_bytes_service):
        ...
        unicode_giver = MockUser("333333333333333333", "🎮Gamer王子👑")
        emoji_receiver = MockUser("444444444444444444", "😊User🎉")
    ...
    async def test_extremely_long_strings(self, edge_case_bytes_service):
        ...
        mock_api_client.post.return_value = AsyncMock(
            ...
            json=lambda: {
                "id": str(uuid4()),
                "guild_id": "123456789012345678",
                "giver_id": "555555555555555555",
                "giver_username": long_username,
                "receiver_id": "666666666666666666",
        ...
        long_user = MockUser("555555555555555555", long_username)
        normal_user = MockUser("666666666666666666", "Normal")
        result = await service.transfer_bytes(
            "123456789012345678",
            long_user,
            normal_user,
        ...
        for i, datetime_str in enumerate(test_cases):
            mock_api_client.get.return_value = AsyncMock(
                ...
                json=lambda dt=datetime_str: {
                    "guild_id": "123456789012345678",
                    "user_id": f"88888888888888888{i:03d}",
                    "balance": 100,
                    "total_received": 150,
                    "total_sent": 50,
                    "streak_count": 5,
            ...
            balance = await service.get_balance("123456789012345678", f"88888888888888888{i:03d}")
    ...
    async def test_concurrent_operations_race_conditions(self, edge_case_bytes_service):
        ...
        for i in range(10):
            responses.append(AsyncMock(
                ...
                json=lambda j=i: {
                    "guild_id": "123456789012345678",
                    "user_id": f"88888888888888888{j:03d}",
                    "balance": 100 + j,
        ...
        for i, balance in enumerate(results):
            assert balance.user_id == f"88888888888888888{i:03d}"
    ...
    async def test_memory_pressure_scenarios(self, edge_case_bytes_service):
        ...
        leaderboard = await service.get_leaderboard("123456789012345678", limit=100)
