...
def upgrade() -> None:
    ...
    # Add the partial unique index with WHERE clause using raw SQL
    op.execute("""
        CREATE UNIQUE INDEX uq_squads_guild_default 
        ON squads (guild_id) 
...
def downgrade() -> None:
    ...
    op.execute("DROP INDEX IF EXISTS uq_squads_guild_default")
